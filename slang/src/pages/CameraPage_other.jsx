...
const CameraPageOther = () => {
  ...
  const [initialPrediction, setInitialPrediction] = useState(true);
  ...
  return (
    ...
    >
      ...
      <div style={{ backgroundColor: 'white', marginLeft: '10px', padding: '1px', height: '100vh', border: '1px solid #ddd' }}>
