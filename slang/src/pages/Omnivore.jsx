...
const Omnivore = () => {
  ...
  const imageUrls = ['고양이.jpg', '기린.jpg', '하마.png', '곰.jpg','코뿔소.jpg','거북이.jpg','개.jpg','고릴라.jpg','낙타.jpg','늑대.jpg','닭.jpeg','돼지.jpg','범.jpg','사슴.jpeg','소.jpg', '악어.jpeg', '양.jpeg', '쥐.jpeg', '토끼.jpg'];
  ...
  const handleSports = () => {
    ...
    if(currentImageIndex == imageUrls.length - 1){
      navigate('/result', { state: { correctAnswer, category: 'animals' } });
    }
    else {
