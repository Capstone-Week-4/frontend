  ...
  <>
    ...
    <ScrollControls pages = {6} damping={0.25}>
      ...
      <Scroll html style = {{width :'100%'}}>
        ...
        <Container style={{position: 'relative'}}>
        <Row className ='text-center align-items-center justify-content-center' style = {{color:'#fff', position:'absolute', width:'50vw', height:'360vh',padding:'0px 30px 0px', top: '85vh'}}>
        <Col xs={10}>
